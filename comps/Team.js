      ...
      <section className="bg-v-brown px-5 sm:px-16 md:px-16 lg:px-32 py-20">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 my-10 gap-20 text-justify">
          <div>
            ...
            After spending 21 years in Africa, where she was born and raised, and 21 years in North America, Relindis decided to leverage her contextual knowledge of both worlds to create impactful solutions for underprivileged youth. In 2018, she founded Vijona Africa and has since been instrumental in establishing a solid foundation for positive impact over the past five years.
            </p>
            <p className="text-primary mb-5">
            Prior to this, Relindis spent 16 years in the technology sector in corporate America, managing finance and healthcare projects for Fortune 10 companies. She holds a bachelor's degree in Management Information Systems from Goldey-Beacom College in Delaware, USA, and is PMP certified by the Project Management Institute. An outdoor enthusiast, Relindis runs marathons and has climbed Mount Kilimanjaro
            </p>
            {/* <p className="text-primary mb-5">
          ...
          <div>
            ...
            <div className="text-primary text-center my-2 ">
              ...
              <p className="text-primary"> President and Chief Executive Officer</p>
            </div>
          </div>
        </div>
        ...
        {!showTeam && (
          <section className="relative py-20 overflow-hidden bg-v-brown">
            ...
            <div className="relative px-16 mx-auto max-w-7xl">
              ...
              <h2 className="relative max-w-lg mt-5 mb-10 text-4xl font-semibold leading-tight lg:text-5xl">Our team is made up of passionate leaders with a wide range of expertise,<br /> a dedicated Advisory board and a strong group of volunteers who have been with us from DAY 1 
              </h2>
