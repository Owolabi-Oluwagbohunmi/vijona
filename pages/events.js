...
export default function events()
{
  ...
  // useEffect(() =>
  // {
  //   setTotalPages(igniteExperience.length())
  // }, [])
        ...
        <div className="flex flex-col items-center justify-center mx-auto xl:flex-row max-w-7x1">
          <div className="relative flex flex-col items-start justify-center w-full h-full max-w-2x1 px-6 mx-auto xl:max-w-none xl:w-2/5">
            ...
            <div className="relative flex mt-6 space-x-2">
              <div onClick={decreasePage()} className="flex items-center justify-center w-10 h-10 text-white bg-indigo-600 rounded cursor-pointer hover:bg-indigo-600">
              ...
              <div onClick={increasePage()} className="flex items-center justify-center w-10 h-10 text-white bg-indigo-600 rounded cursor-pointer hover:bg-indigo-600">
          ...
          <div className="box-content relative flex items-center w-full h-96 max-w-2xl py-5 mx-auto overflow-hidden xl:w-3/5 rounded-xl bg-gradient-to-r from-transparent via-transparent to-gray-100">
            ...
            <div className={"flex px-6 space-x-6 transition duration-500 ease-out transform xl:pl-6 h-94"} className={page > 1 ? "-translate-x-full pr-10" : ""} className={page == 1 ? "relative" : "absolute"}>
            ...
            {/* Continue from here part 2 */}
            <div className="flex space-x-6 transition duration-500 ease-out transform h-94" className={page > 2 ? "-translate-x-full pr-10" : "ranslate-x-0 ml-5"} className={page == 2 ? "relative translate-x-0 ml-5" : "absolute"} x-cloak="">

              {/* <div className="flex space-x-6 transition duration-500 ease-out transform h-94" :className="{'-translate-x-full pr-10' : page > 2, 'translate-x-full' : page < 2, 'translate-x-0 ml-5' : page == 2, 'relative': page == 2, 'absolute': page != 2 }" x-cloak=""> */}
                ...
                <div className="flex-shrink-0">
                  <a href="#_">
                    <div>
                      ...
                      <Image className="object-cover w-full h-32 sm:h-48" src={workshop1} alt="" />
              ...
              <div className="flex flex-col flex-shrink-0 w-1/2 overflow-hidden rounded-lg shadow-lg">
                <div className="flex-shrink-0">
                  <a href="#_">
                    <div>
                      <Image className="object-cover w-full h-32 sm:h-48" src={workshop1} />
                    </div>
            ...
            <div className="flex space-x-6 transition duration-500 ease-out transform h-94" className={page < 3 ? "-translate-x-full" : "ranslate-x-0 ml-5"} className={page == 3 ? "relative translate-x-0 ml-5" : "absolute"} x-cloak="" >
              {/* :className="{'translate-x-full' : page < 3, 'translate-x-0 ml-5' : page == 3, 'relative': page == 3, 'absolute': page != 3 }" x-cloak=""> */}
